...
const DSCRCalculator = ({ isOpen, onClose, isExternalWindow = false }) => {
  ...
  // If rendered in an external window, we don't need the modal overlay
  if (isExternalWindow) {
    return (
    ...
    return (
      <>
              ...
              {parseFloat(dscrResult.dscr) < 1.25 && (
                <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-md">
                  <p className="text-sm text-red-700">
                    Warning: DSCR is below 1.25. Most lenders require a minimum
                    DSCR of 1.25 for investment properties.
                  </p>
                </div>
              )}
              {parseFloat(dscrResult.dscr) >= 1.25 && (
                <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-md">
                  <p className="text-sm text-green-700">
                    Great! Your DSCR is above 1.25, which meets most
        ...
        <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-100">
          <h4 className="font-medium text-blue-800 mb-2">Understanding DSCR</h4>
