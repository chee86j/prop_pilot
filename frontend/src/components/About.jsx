...
const About = () => {
    return (
        <div className="about-container mx-auto px-4 py-6 md:px-8 md:py-10 max-w-4xl bg-white rounded-lg shadow-md">
            <h2 className="text-2xl md:text-3xl font-bold text-center text-gray-700 mb-6">About Prop Pilot</h2>
            <p className="text-sm md:text-md text-gray-600 mb-6">
            Prop Pilot is the brainchild of a software engineer with over 12 years of experience in the property management industry. This transition from hands-on real estate management to innovative software development has fueled our app's creation. Prop Pilot is dedicated to revolutionizing the way real estate investments are handled. Designed for house flippers, developers, construction trade contractors, and real estate accountants our app is a comprehensive solution that streamlines every phase of property management, merging industry expertise with cutting-edge technology.            </p>

            <section className="mb-6">
                <h3 className="text-xl md:text-2xl font-semibold text-gray-700 mb-4">Empowering House Flippers</h3>
            ...
            <section className="mb-6">
                <h3 className="text-xl md:text-2xl font-semibold text-gray-700 mb-4">Streamlining Developers' Workflow</h3>
                <p className="text-sm md:text-md text-gray-600 mb-4">
            ...
            <section className="mb-6">
                <h3 className="text-xl md:text-2xl font-semibold text-gray-700 mb-4">Tool for Construction Trade Contractors</h3>
                <p className="text-sm md:text-md text-gray-600 mb-4">
            ...
            <section className="mb-6">
                <h3 className="text-xl md:text-2xl font-semibold text-gray-700 mb-4">Optimized for Real Estate Accountants</h3>
                <p className="text-sm md:text-md text-gray-600 mb-4">
            ...
            <section className="mb-6">
                <h3 className="text-xl md:text-2xl font-semibold text-gray-700 mb-4">Innovative Features</h3>
                <p className="text-sm md:text-md text-gray-600 mb-4">
            ...
            <section>
                <h3 className="text-xl md:text-2xl font-semibold text-gray-700 mb-4">Our Commitment</h3>
                <p className="text-sm md:text-md text-gray-600">
